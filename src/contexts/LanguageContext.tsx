...
const translations = {
  en: {
    ...
    'testimonials.7.quote': 'I was new to the city and Funect helped me make friends through sports. Amazing experience!',
    'testimonials.7.outcome': 'Built new friendships',
    'testimonials.8.sport': 'Basketball',
    'testimonials.8.quote': 'Great way to stay active and meet people who share the same passion for sports!',
    ...
    'testimonials.8.quote': 'Loistava tapa pysyä aktiivisena ja tavata ihmisiä, jotka jakavat saman intohimon urheiluun!',
    'testimonials.8.outcome': 'Viikoittaiset pelisessiot',
